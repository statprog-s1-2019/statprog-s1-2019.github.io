...
- Visit https://ggplot2.tidyverse.org/index.html for ggplot2 documentation and helpful articles. Reference section contains lots of examples for each geometry type.
...
Not the presence, or lack thereof, of any outliers.
...
tidy_anscombe = datasets::anscombe %>%
  ...
  ungroup() %>%
  arrange(group, index) %>%
  pivot_wider(id_cols = c("group", "index"), names_from = var, values_from = value)
...
.footnote[
http://thewhyaxis.info/gap_remake/
]
